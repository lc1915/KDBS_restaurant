...
{
    public partial class ReceiveGoodsSearch : Form
    {
        ...
        //String sql = "select * from SupplyOrderPrimary where StoreID = 'C01001'";
        String sql = "select * from SupplyOrderPrimary";

        public ReceiveGoodsSearch()
        {
            InitializeComponent();
        }

        private void ReceiveGoodsSearch_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //改变datagridview标题的文字
                dataGridView1.Columns[1].HeaderCell.Value = "收货单编号";
                dataGridView1.Columns[2].HeaderCell.Value = "区域编号";
                //dataGridView1.Columns[3].HeaderCell.Value = "门店编号";
            }
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            String supplyOrderPrimaryID = dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[1].Value.ToString();
            String wareHouseID = dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[2].Value.ToString();

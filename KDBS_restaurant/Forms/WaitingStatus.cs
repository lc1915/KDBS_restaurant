    ...
    public partial class WaitingStatus : Form
    {
        ...
        private void WaitingStatus_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //改变datagridview标题的文字
                dataGridView1.Columns[0].HeaderCell.Value = "等位单编号";
                dataGridView1.Columns[1].HeaderCell.Value = "人数";
                dataGridView1.Columns[2].HeaderCell.Value = "备注";
            }

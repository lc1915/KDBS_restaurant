...
{
    public partial class Cook2 : Form
    {
        ...
        private void Cook2_Load(object sender, EventArgs e)
        {
            String sqlStr = "select * from OrderDetail0 where status=0 and (RecipePrimaryID='FU0001' or RecipePrimaryID='FU0002' or RecipePrimaryID='FU0003' or RecipePrimaryID='FU0004')";
        ...
        {
            dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[5].Value = 1;
        ...
        {
            String sqlStr = "select * from OrderDetail0 where status=0 and (RecipePrimaryID='ZP0101' or RecipePrimaryID='ZP0201' or RecipePrimaryID='ZP0102' or RecipePrimaryID='ZP0202' or RecipePrimaryID='ZP0103' or RecipePrimaryID='ZP0203' or RecipePrimaryID='ZP0301')";
